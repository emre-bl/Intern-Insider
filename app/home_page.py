...
def render_navbar():
    ...
    col1, col2, col3, col4, col5, col6 = st.columns([1, 1.5, 2, 2, 5, 1])
...
def home_page():
    ...
    initialize_session_state()  # must be initialized before any other state variables
    st.set_page_config(page_title="Intern Insider", page_icon="👩", layout="wide")
